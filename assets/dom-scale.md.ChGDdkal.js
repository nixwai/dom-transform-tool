const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/base.Bweia15A.js","assets/chunks/framework.CAZ2cQSD.js","assets/chunks/update-style.Di614ZlN.js"])))=>i.map(i=>d[i]);
import{v as r,ae as d,C as c,o as y,c as o,j as i,a as h,af as g,ag as E,E as a,k as n,w as p,ah as F,ai as m,G as D,p as A}from"./chunks/framework.CAZ2cQSD.js";import{I as u,$ as b}from"./chunks/index.B6nrnH9O.js";const v=`<script setup lang="ts">\r
...
`,x=JSON.parse('{"title":"domScale","description":"","frontmatter":{},"headers":[],"relativePath":"dom-scale.md","filePath":"zh/dom-scale.md"}'),C={name:"dom-scale.md"},T=Object.assign(C,{setup(B){const e=A(!0),l=D();return r(async()=>{l.value=(await d(async()=>{const{default:t}=await import("./chunks/base.Bweia15A.js");return{default:t}},__vite__mapDeps([0,1,2]))).default}),(t,s)=>{const k=c("ClientOnly");return y(),o("div",null,[s[1]||(s[1]=i("h1",{id:"domscale",tabindex:"-1"},[h("domScale "),i("a",{class:"header-anchor",href:"#domscale","aria-label":'Permalink to "domScale"'},"​")],-1)),s[2]||(s[2]=i("p",null,"调整元素的缩放比例",-1)),s[3]||(s[3]=i("h2",{id:"基础用法",tabindex:"-1"},[h("基础用法 "),i("a",{class:"header-anchor",href:"#基础用法","aria-label":'Permalink to "基础用法"'},"​")],-1)),g(a(n(u),null,null,512),[[E,e.value]]),a(k,null,{default:p(()=>[a(n(b),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:s[0]||(s[0]=()=>{e.value=!1}),vueCode:n(v)},F({_:2},[l.value?{name:"vue",fn:p(()=>[a(n(l))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),s[4]||(s[4]=m(`<h2 id="参数类型" tabindex="-1">参数类型 <a class="header-anchor" href="#参数类型" aria-label="Permalink to &quot;参数类型&quot;">​</a></h2><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/** DomScale的配置项 */</span></span>
